...
var propParallax = {
	...
	seccion: document.querySelector('.parallaxBanner'),
	recorrido: null,
	limite: null
...
var metParallax = {
	...
	scrollParallax: function () {
		...
		if ( propParallax.recorrido > propParallax.seccion.offsetTop - window.outerHeight && propParallax.recorrido <= propParallax.limite ) {
			...
			propParallax.seccion.style.backgroundPositionY = (propParallax.recorrido - propParallax.seccion.offsetTop) / 1.8 + 'px';
